...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-to-image-37389292
```

A live public deployment of this template is available at [https://text-to-image-37389292.templates.workers.dev](https://text-to-image-37389292.templates.workers.dev)
